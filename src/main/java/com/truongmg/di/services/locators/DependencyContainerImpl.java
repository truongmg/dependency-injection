...
public class DependencyContainerImpl implements DependencyContainer {
    ...
    public <T> T getService(Class<T> serviceType) {
        ...
        if (serviceDetails != null) return serviceDetails.getInstance();
        return null;
    }

    @Override
    public <T> ServiceDetails<T> getServiceDetails(Class<T> serviceType) {
        ServiceDetails<T> serviceDetails = findServiceDetails(serviceType);
    ...
    private <T> ServiceDetails<T> findServiceDetails(Class<T> serviceType) {
    ...
    private <T> Object getNewInstance(Class<T> serviceType) {
        ...
        T instance = serviceDetails.getInstance();
        return instance;
    }
